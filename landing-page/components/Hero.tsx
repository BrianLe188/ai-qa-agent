      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-6">
            ...
            <span className="text-xs font-mono text-white/80 uppercase tracking-wider">v2.0 is live</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a href="https://github.com/BrianLe188/ai-qa-agent" target="_blank" rel="noreferrer" className="glow-button-green px-8 py-4 flex items-center gap-2 text-lg">
              <Github className="w-5 h-5" />
              View on GitHub
            </a>
            <a href="https://github.com/BrianLe188/ai-qa-agent" target="_blank" rel="noreferrer" className="px-8 py-4 rounded-lg border border-white/10 hover:bg-white/5 transition-colors text-lg font-medium flex items-center gap-2">
